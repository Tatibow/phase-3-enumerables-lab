...
def print_spiciest_foods(spicy_foods)
  heat_filter = spicy_foods.select do |food|
    food[:heat_level] > 5
  end
  heat_filter.map{|food| puts "#{food[:name]} (#{food[:cuisine]}) | Heat Level: #{" 🌶 " * food[:heat_level]} "}
end
